...
<p>
  ...
  <a href="mailto:sebastian.paintner@posteo.org">
    sebastian.paintner@posteo.org
  </a>
</p>
<p>
  <strong>Impressum</strong>:{" "}
  <a href="https://litc0de.now.sh/imprint" target="_blank">
    https://litc0de.now.sh/imprint
  </a>
</p>
...
<ul class="m-elements">
  ...
  <li>
    ...
    </a>; Privacy Shield (Gewährleistung Datenschutzniveau bei Verarbeitung von Daten
    in den USA): <a
      href="https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&status=Active"
      target="_blank"
    >
      https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&status=Active
    </a>; Widerspruchsmöglichkeit (Opt-Out): Einstellungen für Werbeanzeigen:{" "}
  ...
  <li>
    ...
    </a>; Widerspruchsmöglichkeit (Opt-Out):{" "}
    <a
